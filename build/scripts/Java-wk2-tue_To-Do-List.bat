...
@rem ##########################################################################
@rem
@rem  Java-wk2-tue_To-Do-List startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and JAVA_WK2_TUE_TO_DO_LIST_OPTS to pass JVM options to this script.
...
:fail
rem Set variable JAVA_WK2_TUE_TO_DO_LIST_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%JAVA_WK2_TUE_TO_DO_LIST_EXIT_CONSOLE%" exit 1
exit /b 1
